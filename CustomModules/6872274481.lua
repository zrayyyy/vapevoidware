...
local function vapeGithubRequest(scripturl)
	if not isfile("vape/"..scripturl) then
		...
		warn("The following file cannot be downloaded in this version of Voidware. Please either download the folder from the discord server or dm erchobg#0 on discord with the following file name: "..scripturl)
	end
